...
## Basic Damage Per Weapon For Players
- Keeps track of damage a player has done to an enemy.
...
**bOnlyTrackWeaponDamage** must be set to **False** for these to be tracked.
 - Damage Delt
 - Damage Received
 - Self Damage Taken
 - Team Damage Delt
